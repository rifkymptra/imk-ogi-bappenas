<template>
  <div id="app">
    ...
    <div
      class="container mx-auto flex justify-center items-center mt-5 px-4 gap-4"
    >
      <SearchBar
        placeholder="Cari Infografis"
        customClasses="w-full max-w-[676px]"
        maxWidth="676px"
    ...
    <div class="container mx-auto mt-10 justify-center flex">
      <div class="w-full max-w-[1311px] justify-center flex">
        <div
          v-if="filteredAndPaginatedData.length > 0"
        ...
        <div
          v-else
          class="text-center text-neutral-1 font-jakarta text-[16px] mt-10"
        >
    ...
    <!-- Pagination -->
    <div
      v-if="totalPages > 1 && filteredAndPaginatedData.length > 0"
    ...
    >
      ...
      <button
        ...
        :class="{
          ...
          'bg-white text-neutral-2 border border-neutral-3':
            currentPage !== totalPages,
        }"
  ...
  computed: {
    ...
    filteredCards() {
      return this.cardsData.filter((card) => {
        const matchesTitle = card.judul
          .toLowerCase()
          .includes(this.searchQuery.toLowerCase());
        const matchesDate = card.tanggal
          .toLowerCase()
          .includes(this.searchQuery.toLowerCase());
        const matchesCategory = this.categoryFilter
          ? card.kategori === this.categoryFilter
          : true;
        const matchesYear = this.yearFilter
          ? card.tahun === this.yearFilter
          : true;
