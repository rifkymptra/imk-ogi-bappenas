          ...
          <div class="w-1/4">
            <div class="p-4 bg-white shadow rounded-lg">
              ...
              <div class="flex space-x-0.3 mb-4 rounded-full p-0.5">
                ...
                <button
                  @click="setSortCriteria('mostDownloaded')"
                  :class="{
              ...
              <div v-for="(report, index) in paginatedReports" :key="index" class="p-4 bg-white shadow-card rounded-lg">
                ...
                <div class="flex justify-between items-center mt-2">
                  <a :href="report.link" target="_blank">
                    <button class="w-[79px] h-[32px] font-jakarta font-bold text-[13px] bg-primary-1 text-white rounded-lg hover:bg-primary-3 focus:outline-none">Unduh</button>
                  </a>
                  <div class="text-gray-500 text-sm flex space-x-4">
                    ...
                    <span class="flex items-center font-jakarta font-semibold text-[10px] text-neutral-3">
                      <i data-feather="download" class="icon-eye mr-1"></i> {{ report.totalDownload.toLocaleString() }}
                    </span>
                  </div>
                </div>
              </div>
